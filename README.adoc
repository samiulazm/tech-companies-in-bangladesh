...
|Inovace Technologies Limited
|4th Floor,  18 Kazi Nazrul Islam Ave, Dhaka 1205
|PHP, Laravel, MySQL, MS-SQL Server, Java, MQTT, Python, Spring boot, Kafka, JavaScript, Node.js, Flask, Bootstrap, PostgreSQL, Angular.js, Vue.js, Wordpress, C#, .NET , IoT, C, C++
